...
const LeadsAdminPanel = () => {
  ...
  return (
    <Box sx={{ p: 0, width: '100vw', backgroundColor: '#f5f5f5', minHeight: '100vh' }}>
      {/* Header */}
      <Paper sx={{ p: 7, mb: 3, background: 'linear-gradient(135deg, #4caf50 0%, #2e7d32 100%)', color: 'white' }}>
        <Box sx={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between' }}>
          ...
          <Fab color="secondary" onClick={() => setOpenDialog(true)}>
            <AddIcon />
          </Fab>
        </Box>
      </Paper>
...
>
  ...
  >
    {selectedLead ? 'Lead Details' : 'Add New Lead'}
